# Reset SME-Guard data via Docker Compose (bukan Windows Postgres di :5432).
#
...
#   .\scripts\reset_smeguard_docker.ps1 -ClearLogs -ResetAll
#
# Flags:
...
try {
    ...
    Write-Host "Mereset SME-Guard via Docker (hostname postgres & redis, bukan localhost)..." -ForegroundColor Cyan
